...
import org.hermes.messenger.BuildVars;
...
import org.hermes.ui.Cells.TextInfoCell;
import org.hermes.ui.Cells.EmptyCell;
import org.hermes.ui.Cells.HeaderCell;
import org.hermes.ui.Cells.ShadowSectionCell;
import org.hermes.ui.Cells.TextCheckCell;
import org.hermes.ui.Cells.TextDetailSettingsCell;
import org.hermes.ui.Cells.TextSettingsCell;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                if (i == textSizeRow) {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                    showAlertDialog(builder);
                } else if (i == hermesFaqRow) {
                    try {
                        Intent pickIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(LocaleController.getString("HermesFaqUrl", R.string.HermesFaqUrl)));
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return i == textSizeRow || i == enableAnimationsRow || i == notificationRow || i == backgroundRow || i == numberRow ||
                    ...
                    i == switchBackendButtonRow || i == hermesFaqRow || i == contactsSortRow || i == contactsReimportRow || i == saveToGalleryRow;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == textSizeRow) {
                    ...
                    textCell.setText(LocaleController.getString("HermesFAQ", R.string.HermesFaq), true);
                } else if (i == contactsReimportRow) {
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "Hermes for Android v%s (%d)", pInfo.versionName, pInfo.versionCode));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
        ...
        public int getItemViewType(int i) {
            if (i == emptyRow || i == overscrollRow) {
                ...
                return 3;
            } else if (i == notificationRow || i == backgroundRow || i == askQuestionRow || i == sendLogsRow || i == privacyRow || i == clearLogsRow || i == switchBackendButtonRow || i == hermesFaqRow || i == contactsReimportRow || i == textSizeRow || i == languageRow || i == contactsSortRow) {
                return 2;
